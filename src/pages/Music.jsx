        ...
        <div className="cj-mantra-row animate-fade-in-up delay-200">
          <div className="cj-mantra-text">
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              Ready to experience the movement in person? Get access to upcoming shows and events.
            </p>
            <p style={{ marginBottom: '2rem', fontSize: '1.1rem', color: 'var(--gold-bright)' }}>
              To book, email: <br/>
              <a href="mailto:music@caligrafijones.com" style={{ color: '#fff', textDecoration: 'underline', marginTop: '0.5rem', display: 'inline-block' }}>music@caligrafijones.com</a>
            </p>
            <a href="mailto:music@caligrafijones.com" className="cj-btn-outline" style={{ display: 'inline-flex' }}>
              Book Now <Mail size={20} style={{ marginLeft: '10px' }} />
            </a>
          </div>
          <div className="cj-mantra-image-container">
